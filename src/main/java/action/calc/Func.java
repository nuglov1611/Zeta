...
import action.calc.objects.ArrayIterator;
import action.calc.objects.HashIterator;
import action.calc.objects.StringIterator;
import action.calc.objects.class_constructor;
import action.calc.objects.class_iterator;
import action.calc.objects.class_size;
import action.calc.objects.class_type;
import action.calc.objects.iterator;
                ...
                if (o instanceof Vector) {
                    ...
                    try {
                        for (Enumeration<Object> e = ((Vector<Object>) o)
                            ...
                            if (ZetaProperties.calc_debug > 2) {
                                log.debug("set arg " + (String) t.left + " to "
                                        + bar);
                            }
                ...
                if (method.equals("SIZE") && (obj instanceof class_size)) {
                    ...
                    if (method.equals("LENGTH") || method.equals("SIZE")) {
                        ...
                        if ((x instanceof Vector)
                            ...
                            return ((String) obj)
                                    .substring(((Double) ((Vector<Double>) x)
